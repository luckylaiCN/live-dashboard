...
function length_cut(str: string, max: number = 10): string {
    return str.length > max ? str.slice(0, max) + "..." : str;
}

// Video apps
registerTemplate(["YouTube"], (t) => `正在YouTube看「${length_cut(t)}」喵~`);
registerTemplate(["哔哩哔哩", "bilibili"], (t) => `正在B站看「${length_cut(t)}」喵~`);
registerTemplate(["Netflix"], (t) => `正在Netflix看「${length_cut(t)}」喵~`);
registerTemplate(["爱奇艺"], (t) => `正在爱奇艺看「${length_cut(t)}」喵~`);
registerTemplate(["优酷"], (t) => `正在优酷看「${length_cut(t)}」喵~`);
registerTemplate(["腾讯视频"], (t) => `正在腾讯视频看「${length_cut(t)}」喵~`);
registerTemplate(["VLC", "PotPlayer", "mpv"], (t) => `正在看「${length_cut(t)}」喵~`);
// New video platforms
registerTemplate(["Twitch"], (t) => `正在Twitch看「${length_cut(t)}」喵~`);
registerTemplate(["Disney+"], (t) => `正在Disney+看「${length_cut(t)}」喵~`);
registerTemplate(["芒果TV"], (t) => `正在芒果TV看「${length_cut(t)}」喵~`);
registerTemplate(["斗鱼"], (t) => `正在斗鱼看「${length_cut(t)}」喵~`);
registerTemplate(["虎牙"], (t) => `正在虎牙看「${length_cut(t)}」喵~`);
registerTemplate(["Prime Video"], (t) => `正在Prime Video看「${length_cut(t)}」喵~`);
registerTemplate(["HBO"], (t) => `正在HBO看「${length_cut(t)}」喵~`);

// Music apps
registerTemplate(["Spotify"], (t) => `正在Spotify听「${length_cut(t)}」喵~`);
registerTemplate(["网易云音乐"], (t) => `正在网易云听「${length_cut(t)}」喵~`);
registerTemplate(["QQ音乐"], (t) => `正在QQ音乐听「${length_cut(t)}」喵~`);
registerTemplate(["酷狗音乐"], (t) => `正在酷狗听「${length_cut(t)}」喵~`);
registerTemplate(["Apple Music"], (t) => `正在Apple Music听「${length_cut(t)}」喵~`);
registerTemplate(["foobar2000"], (t) => `正在听「${length_cut(t)}」喵~`);
registerTemplate(["YouTube Music"], (t) => `正在YouTube Music听「${length_cut(t)}」喵~`);
registerTemplate(["酷我音乐"], (t) => `正在酷我听「${length_cut(t)}」喵~`);
registerTemplate(["Amazon Music"], (t) => `正在Amazon Music听「${length_cut(t)}」喵~`);
registerTemplate(["AIMP"], (t) => `正在听「${length_cut(t)}」喵~`);

// IDE / editors
registerTemplate(["VS Code", "Visual Studio Code"], (t) => {
    const first_part = t.includes(" - ") ? t.split(" - ")[0] : t;
    return `正在用VS Code写「${first_part}」喵~`;
});
registerTemplate(["Cursor"], (t) => `正在用Cursor写「${length_cut(t)}」喵~`);
registerTemplate(["IntelliJ IDEA"], (t) => `正在用IDEA写「${length_cut(t)}」喵~`);
registerTemplate(
    [
        "PyCharm",
        "WebStorm",
    ...
    (t) => `正在写「${length_cut(t)}」喵~`,
);
registerTemplate(["Sublime Text"], (t) => `正在用Sublime写「${length_cut(t)}」喵~`);
registerTemplate(["Visual Studio"], (t) => `正在用VS写「${length_cut(t)}」喵~`);
registerTemplate(
    ["Google Antigravity"],
    (t) => `正在用Antigravity写「${length_cut(t)}」喵~`,
);
registerTemplate(["Windsurf"], (t) => `正在用Windsurf写「${length_cut(t)}」喵~`);
registerTemplate(["Zed"], (t) => `正在用Zed写「${length_cut(t)}」喵~`);
registerTemplate(
    ["CLion", "RustRover", "JetBrains Fleet", "HBuilderX"],
    (t) => `正在写「${length_cut(t)}」喵~`,
);
registerTemplate(["Vim", "Neovim"], (t) => `正在用Vim写「${length_cut(t)}」喵~`);
registerTemplate(["Emacs"], (t) => `正在用Emacs写「${length_cut(t)}」喵~`);
registerTemplate(["Notepad++"], (t) => `正在用Notepad++写「${length_cut(t)}」喵~`);

// Dev tools
registerTemplate(["Docker Desktop"], (t) => `正在用Docker搞「${length_cut(t)}」喵~`);
registerTemplate(["GitHub Desktop"], (t) => `正在GitHub上搞「${length_cut(t)}」喵~`);
registerTemplate(["Postman"], (t) => `正在用Postman调「${length_cut(t)}」喵~`);
registerTemplate(["DBeaver", "Navicat"], (t) => `正在查「${length_cut(t)}」数据库喵~`);
registerTemplate(["Insomnia"], (t) => `正在用Insomnia调「${length_cut(t)}」喵~`);
registerTemplate(["GitKraken"], (t) => `正在用GitKraken搞「${length_cut(t)}」喵~`);
registerTemplate(["Sourcetree"], (t) => `正在用Sourcetree搞「${length_cut(t)}」喵~`);
registerTemplate(["Termius"], (t) => `正在用Termius远程喵~`);

// Gaming platforms — displayTitle IS the game title
registerTemplate(["Steam"], (t) => `正在Steam玩「${length_cut(t)}」喵~`);
registerTemplate(["Epic Games"], (t) => `正在Epic玩「${length_cut(t)}」喵~`);
registerTemplate(["GOG Galaxy"], (t) => `正在GOG玩「${length_cut(t)}」喵~`);
registerTemplate(["Xbox"], (t) => `正在Xbox玩「${length_cut(t)}」喵~`);
registerTemplate(["EA App"], (t) => `正在EA玩「${length_cut(t)}」喵~`);
registerTemplate(["Ubisoft Connect"], (t) => `正在育碧玩「${length_cut(t)}」喵~`);
registerTemplate(["Battle.net"], (t) => `正在暴雪玩「${length_cut(t)}」喵~`);
...
// Productivity
registerTemplate(["Word", "Microsoft Word"], (t) => `正在用Word写「${length_cut(t)}」喵~`);
registerTemplate(
    ["Excel", "Microsoft Excel"],
    (t) => `正在用Excel看「${length_cut(t)}」喵~`,
);
registerTemplate(
    ["PowerPoint", "Microsoft PowerPoint"],
    (t) => `正在做「${length_cut(t)}」PPT喵~`,
);
registerTemplate(["OneNote"], (t) => `正在OneNote写「${length_cut(t)}」喵~`);
registerTemplate(["Notion"], (t) => `正在Notion看「${length_cut(t)}」喵~`);
registerTemplate(["Obsidian"], (t) => `正在Obsidian写「${length_cut(t)}」喵~`);
registerTemplate(["Typora"], (t) => `正在Typora写「${length_cut(t)}」喵~`);
registerTemplate(["WPS Office", "WPS"], (t) => `正在用WPS写「${length_cut(t)}」喵~`);
registerTemplate(["Google Docs"], (t) => `正在Google文档写「${length_cut(t)}」喵~`);
registerTemplate(["Logseq"], (t) => `正在Logseq写「${length_cut(t)}」喵~`);

// Design tools
registerTemplate(["Figma"], (t) => `正在用Figma做「${length_cut(t)}」喵~`);
registerTemplate(
    ["Photoshop", "Adobe Photoshop"],
    (t) => `正在用Photoshop修「${length_cut(t)}」喵~`,
);
registerTemplate(
    ["Illustrator", "Adobe Illustrator"],
    (t) => `正在用Illustrator画「${length_cut(t)}」喵~`,
);
registerTemplate(
    ["Premiere Pro", "Adobe Premiere Pro"],
    (t) => `正在用Premiere剪「${length_cut(t)}」喵~`,
);
registerTemplate(
    ["After Effects", "Adobe After Effects"],
    (t) => `正在用AE做「${length_cut(t)}」喵~`,
);
registerTemplate(["Blender"], (t) => `正在用Blender搞「${length_cut(t)}」喵~`);
registerTemplate(["DaVinci Resolve"], (t) => `正在用达芬奇剪「${length_cut(t)}」喵~`);
registerTemplate(["剪映", "CapCut"], (t) => `正在用剪映剪「${length_cut(t)}」喵~`);
registerTemplate(
    ["Lightroom", "Adobe Lightroom"],
    (t) => `正在用Lightroom修「${length_cut(t)}」喵~`,
);
registerTemplate(
    ["SAI", "Clip Studio Paint", "MediBang", "Krita"],
    (t) => `正在画「${length_cut(t)}」喵~`,
);

// Reading
registerTemplate(["Kindle"], (t) => `正在Kindle看「${length_cut(t)}」喵~`);
registerTemplate(["微信读书"], (t) => `正在微信读书看「${length_cut(t)}」喵~`);

// Browser — when display_title is available (video site page, generic page title)
registerTemplate(["Google Chrome", "Chrome"], (t) => `正在用Chrome看「${length_cut(t)}」喵~`);
registerTemplate(["Opera GX"], (t) => `正在用Opera GX看「${length_cut(t)}」喵~`);
registerTemplate(["Microsoft Edge"], (t) => `正在用Edge看「${length_cut(t)}」喵~`);
registerTemplate(["Firefox"], (t) => `正在用Firefox看「${length_cut(t)}」喵~`);
registerTemplate(["Safari", "Opera", "Arc"], (t) => `正在用${t.split(" ")[0]}看「${length_cut(t)}」喵~`);
registerTemplate(["Brave"], (t) => `正在用Brave看「${length_cut(t)}」喵~`);
registerTemplate(["Vivaldi"], (t) => `正在用Vivaldi看「${length_cut(t)}」喵~`);
...
export function getAppDescription(
    ...
    if (displayTitle) {
        return `正在运行「${length_cut(displayTitle)}」喵~`;
    }
